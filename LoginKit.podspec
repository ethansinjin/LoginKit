...
Pod::Spec.new do |s|
  ...
  s.name         = "LoginKit"
  s.version      = "0.0.6"
  s.summary      = "A CocoaPod to facilitate app login on iOS"
  ...
  s.author             = { "Ethan Gill" => "ethansinjin@gmail.com" }
  # Or just: s.author    = "Ethan Gill"
  # s.authors            = { "Ethan Gill" => "egill@elinkdesign.com" }
  s.social_media_url   = "http://twitter.com/ethansinjin"
  ...
  s.source       = { :git => "https://github.com/ethansinjin/LoginKit.git", :tag => "#{s.version}" }
